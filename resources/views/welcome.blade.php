...
<div class="container-fluid px-5 ">
    ...
    <div class="row">
        ...
        @if (count($latest_products) != 0)
            ...
            <div class="row w-100">
                ...
                @foreach ($latest_products as $product)
                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                        <div class="box-product latest-product item  m-2 position-relative">
                            <a href="{{ route('product-details', $product->id) }}" class="product-header d-block">
                                <div class="bg-container-product"
            ...
            <h3 class="text-center w-100 mt-2"><a href="{{ route('see_more', 'latest') }}"
                    class="btn btn-lg btn-outline-primary"> رؤية المزيد</a></h3>
        @endif
        ...
        @if (count($offers_products) != 0)
            ...
            <div class="row  w-100">
                ...
                @foreach ($offers_products as $product)
                    <div
                        class="col-sm-4 col-md-4 col-lg-3 col-xl-3 m-3 box-product d-flex special-orders row position-relative">
                        ...
                        <div class="p-0 product-footer col-12 position-absolute mt-1" style="bottom:0 !important;">
                            <a class="w-100" href="{{ route('product-details', $product->id) }}">تفاصيل
                                المنتج</a>
                        </div>
                    </div>
                @endforeach
            ...
            <h3 class="text-center w-100 mt-2"><a href="{{ route('see_more', 'offers') }}"
                    class="btn btn-lg btn-outline-primary"> رؤية المزيد</a></h3>
        ...
        @if (count($high_sales) != 0)
            ...
            <div class="row w-100">
                ...
                @foreach ($high_sales as $product)
                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                        <div class=" m-3 box-product latest-product item position-relative">
                            <a href="{{ route('product-details', $product->id) }}" class="product-header d-block">
                                <div class="bg-container-product"
                            ...
                            <div class="product-body">
                                ...
                                <div class="stars-rate" dir="rtl">
                                    ...
                                    <input type="hidden" id="rate_star_h{{ $product->id }}"
                                        value="{{ $product->reviews_stars }}">
                                    <div class="text-primary d-inline-block">
            ...
            <h3 class="text-center w-100 mt-2"><a href="{{ route('see_more', 'high_sale') }}"
                    class="btn btn-lg btn-outline-primary"> رؤية المزيد</a></h3>
        ...
        <div class="row pl-5 pr-5" style="padding-bottom: 70px">
            ...
            <div class="col-sm-6 col-md-4 col-lg-2">
                ...
                <ul class="footer-list text-left">
                    <li>
                        <a href="#">
                            <img src="{{ URL::asset('resources/assets/images/footer-paypal.png') }}"
                                class="img-fluid" alt="paypal">
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="{{ URL::asset('resources/assets/images/footer-visa.png') }}"
                                class="img-fluid" alt="visa">
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="{{ URL::asset('resources/assets/images/footer-mastercard.png') }}"
                                class="img-fluid" alt="mastercard">
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="{{ URL::asset('resources/assets/images/footer-pay.png') }}"
